...
@Component({
  ...
  templateUrl: './login-patient-dialog.component.html',
  styleUrls: ['./login-patient-dialog.component.scss']
})
export class LoginPatientDialogComponent implements OnInit {
